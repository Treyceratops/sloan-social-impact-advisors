		...
		return (
			<div className='about'>
				...
				<p className='p2 about-p2'>
					...
					organizations to achieve financial and/or social impact. Alex has held
					leadership roles across the social change landscape including in
					venture capital, corporate social impact, private foundations, global
					public charities, nonprofit organizations, and US government agencies.
					Alex has worked on and led teams that have raised and deployed over $1
					billion in investment and philanthropic capital. He has worked closely
					as advisor, funder, and/or board member to dozens of leadership teams
					to drive outcomes.
				</p>
				<div className='bio'>
					<div className='bio-text'>
						...
						<p>
							Alex has served many times as coach, mentor, and advisor to senior
						...
						<p>
							Alex served in several corporate social impact leadership roles at
							leading identity security software companies{' '}
						...
						<p>
							...
							President of Strategic Partnerships & Communications at{' '}
						...
						<p>
							He was Director of Innovation Investments and Portfolio Director
							at the Skoll Foundation, leading its signature Skoll Awards for
							Social Entrepreneurship program.
						</p>
						<p>
							Prior to his work in philanthropy, Alex spent 20 years in
							leadership roles at several leading venture capital firms in Hong
							Kong, Vietnam, and Silicon Valley.
						</p>
						<p>
